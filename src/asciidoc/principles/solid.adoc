...
* Les exemples sont issus de https://objectmentor.com/resources/articles/srp.pdf[SRP: The Single Responsibility Principle], Robert C. Martin
...
* Les exemples sont issus de https://objectmentor.com/resources/articles/ocp.pdf[The Open-Closed Principle], Robert C. Martin
...
** if for each object latexmath:[o_1] of type latexmath:[S] there is an object latexmath:[o_2] of type latexmath:[T] such that for all programs latexmath:[P] defined in terms of latexmath:[T], the behavior of latexmath:[P] is unchanged when latexmath:[o_1] is substituted for latexmath:[o_2] then latexmath:[S] is a subtype of latexmath:[T].
* également lié à l’approche _Design By Contract_, Bertrand Meyer
** derived methods should expect no more and provide no less.
* Les exemples sont issus de https://objectmentor.com/resources/articles/lsp.pdf[The Liskov Substitution Principle], Robert C. Martin
...
=== Exemple de violation de LSP 1/3
.La class `Rectangle`
[source,java,indent=0]
----
include::{sourcedir}/solid/lsp/Rectangle.java[tag=rectangle]
----

=== Exemple de violation de LSP 2/3
.La class `SquareWrong`
[source,java,indent=0]
----
include::{sourcedir}/solid/lsp/SquareWrong.java[tag=square-wrong]
----
...
=== Exemple de violation de LSP 3/3
.L'aire du rectangle est 12
[source,java,indent=0]
----
include::{testdir}/solid/lsp/LspTest.java[tag=test-rectangle]
----

.L'aire du carré devrait être 12 mais ...
[source,java,indent=0]
----
include::{testdir}/solid/lsp/LspTest.java[tag=test-lsp-violation]
----

----
[INFO] Running fr.uvsq.coo.solid.lsp.LspTest
[ERROR] Tests run: 2, Failures: 1, Errors: 0, Skipped: 0, Time elapsed: 0.016 s <<< FAILURE! -- in fr.uvsq.coo.solid.lsp.LspTest
[...]
[INFO] Results:
[ERROR] Failures: 
[ERROR]   LspTest.testLspViolation:21 Area should be 12 ==> expected: <12> but was: <16>
----
...
* Les exemples sont issus de https://objectmentor.com/resources/articles/isp.pdf[The Interface Segregation Principle], Robert C. Martin

=== Exemple de violation de ISP 1/3
[source,java]
----
...
* dépend d'une bibliothèque GUI (_JavaFX_)

=== Exemple de violation de ISP 2/3
[source,java]
----
...
=== Exemple de violation de ISP 3/3
[source,java]
----
...
* Met en œuvre le pattern _Adaptateur_

=== Exemple respectant ISP 2/2
[source,java]
----
...
* L’application géométrique ne dépend plus de l’application graphique et de ses changements
...
* Plus de détails dans https://objectmentor.com/resources/articles/dip.pdf[The Dependency Inversion Principle], Robert C. Martin

=== Exemple d’application de DIP
//TODO: changer et développer cet exemple
[source,java]
----
...
** utilisation du pattern AbstractFactory ou de l’_injection de dépendances_
