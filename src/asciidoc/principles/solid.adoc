...
* Les exemples sont issus de _The Liskov Substitution Principle, Robert C. Martin_
...
* Les exemples sont issus de _The Interface Segregation Principle, Robert C. Martin_
