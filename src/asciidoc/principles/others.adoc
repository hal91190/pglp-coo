...
* Repris dans l'article https://objectmentor.com/resources/articles/granularity.pdf[Granularity], Robert C. Martin
...
* Un module a une granularité adaptée à la distribution ⇒ c'est aussi l’unité de réutilisation
...
* Ensemble de principes publiés dans la revue _The C++ Report_ par Robert C. Martin
* Repris dans les articles https://objectmentor.com/resources/articles/granularity.pdf[Granularity] et https://objectmentor.com/resources/articles/stability.pdf[Stability], Robert C. Martin
